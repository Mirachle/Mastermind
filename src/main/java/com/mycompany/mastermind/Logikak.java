...
/**
 * A {@code Logikak} osztályban jön létre maga a játéklogika. Itt bírálódik el minden eldöntendő kérdés, 
...
public class Logikak {
    ...
    /**
     * A {@code jatekVegeVizsgalo} metódus megnézi, hogy vége van-e a játéknak.
