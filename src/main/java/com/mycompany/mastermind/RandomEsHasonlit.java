...
/**
 *A {@code RandomEsHasonlit} osztályban generálódik le a kitalálandó színkód, illetve itt történik a kipróbált színek és a szinkód összehasonlítása is.
 */
public class RandomEsHasonlit {
    ...
    /**
     * A {@code szinKod} listában tárolódik a kitalálandó random színkód.
     */
    private List<Integer> szinKod = new ArrayList();
    
    /**
     * A {@code szinKodCopy} lista a szinKód másolata, az összehasonlításokhoz.
     */
    private List<Integer> szinKodCopy = new ArrayList();

    /**
     * A {@code winner} változó reprezentálja, hogy hány fekete karikánk van. Ha a winner négy, akkor győztünk.
     */
    private int winner = 0;
    
    /**
     * A {@code randomSzinGenerator} metódus legenerálja a kitalálandó színkódot.
     */
    ...
    /**
     * Megvizsgálja hány színt találtál el jó helyen.
    ...
    /**
     * Megvizsgálja hány színt találtál el, de rossz helyen.
    ...
    /**
     * Törli a szinKod-ot, a szinKodCopy-t, majd a winnert nullázza.
